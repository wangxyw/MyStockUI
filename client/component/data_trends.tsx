...
import { Button, DatePicker, Select, Space, Card, Row, Col, Spin, message, Statistic } from 'antd';
...
const SimpleAlarmTrend: React.FC = () => {
  const [days, setDays] = useState<number>(120); // 默认120天
